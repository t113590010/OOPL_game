...
namespace GameConfig {
    ...
    constexpr float PAUSE_BUTTON_RATIO_Y =  0.9;
    constexpr float PAUSE_BUTTON_RATIO_X = -0.95;
    constexpr float PAUSE_BUTTON_SIZE = 50.0f;
    ...
    constexpr float SPAWN_OFFSET_X = 20.0f;
    constexpr float SPAWN_OFFSET_Y = 0.0f;
    constexpr float RANDOM_SPAWN_OFFSET_Y_MAX = 6;
